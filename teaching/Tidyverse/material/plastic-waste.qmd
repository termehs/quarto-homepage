...
You can read it in using the following (make sure you save the data in your working directory).
...
4.  Recreate the following plot, and interpret what you see in context of the data.
