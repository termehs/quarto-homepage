...
Since 2015, I am working with [Ove Frank](https://scholar.google.com/citations?user=9hTp2rsAAAAJ&hl=en) and [Krzysztof Nowicki](https://portal.research.lu.se/en/persons/krzysztof-nowicki) on a project in which we build a systematic framework for using statistical entropy tools to analyze network data. A forthcoming monograph on the topic is expected in the coming year.
